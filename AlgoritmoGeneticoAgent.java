...
public class AlgoritmoGeneticoAgent extends Agent {
    ...
    protected void setup() {
        System.out.println("Agente de " + getLocalName() + " iniciado.");
    ...
    // Clase Data para encapsular los datos
    static class Data {
        double[] x;
        double[] y;
    ...
    private String solveWithGeneticAlgorithm(Data data) {
        ...
        poblacion = inicializarPoblacion(tamPoblacion);
    ...
    //Selecciona un padre usando el método de la ruleta
    ...
    private class ReceiveDatasetBehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null && msg.getConversationId().equals("analisis-genetico")) {
                ...
                String resultado = solveWithGeneticAlgorithm(data);
