...
public class RegresionMultipleAgent extends Agent {
    ...
    protected void setup() {
        ...
        sd.setType("servicio-regresion-multiple");
        // Asigna un nombre al servicio
        sd.setName("servicio-regresion-multiple");
        dfd.addServices(sd);
        try {
            // registra el agente
    ...
    private String calcularRegresionMultiple(double[] x1, double[] x2, double[] y) {
        ...
        double sumX1C = discretas.sumatoriaExponencial(x1);
        double sumX2C = discretas.sumatoriaExponencial(x2);
        ...
        double[][] matrix = {
                ...
                { sumX1, sumX1C, sumX1X2 },
                { sumX2, sumX1X2, sumX2C }
        };
    ...
    private class ReceiveDatasetBehaviour extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (msg != null && msg.getConversationId().equals("analisis-regresion")) {
                ...
                String regressionResult = calcularRegresionMultiple(x1Values, x2Values, yValues);
